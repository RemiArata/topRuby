...
def add_language(languages, language_name, language_info_value)
  ...
  return languages[language_name] = language_info_value
end
...
def delete_language(languages, language_name)
  ...
  # languages
  return languages.delete(language_name)
end
...
# print find_beautiful_languages(h)
...
print find_language_facts(h, :ruby, 1)