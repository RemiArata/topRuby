def blank_seating_chart(number_of_rows, seats_per_row)
  ...
  # change with it
  return Array.new(number_of_rows) {Array.new(seats_per_row, "e")}
end

b = blank_seating_chart(2, 3)
...
def add_seat_to_row(chart, row_index, seat_to_add)
  ...
  chart[row_index][-1] = seat_to_add
  return chart
end

# print add_seat_to_row(b, 1, "remi")
...
b = add_another_row(b, ["remi", "lexi", "e"])
...
# print delete_seat_from_row(b, 2, 0)
...
arr_of_hashes =  [
          ...
          { name: 'JavaScript', is_my_favorite?: true },
          { name: 'HTML', is_my_favorite?: false }
        ]
puts find_favorite(arr_of_hashes)